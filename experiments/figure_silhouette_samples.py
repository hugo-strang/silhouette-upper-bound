...
data = utils.get_silhouette_plot_data(kmeans_dict["best_labels"], scores, centers, ub_samples)
...
ax.set_xlabel("Silhouette width (opaque)\nand corresponding upper bound (transparent)", fontsize=14)

plt.savefig("../figures/silhouette_samples.pdf", bbox_inches="tight")
plt.close()